...
void pdg::KSplitStatsCollector::PrintKernelIdiomStats()
{
  ...
  kernel_idiom_stats_file << "num of func pointer: " << num_of_func_pointer_ << "\n";
...
void pdg::KSplitStatsCollector::PrintKernelIdiomSharedStats()
{
  ...
  kernel_idiom_shared_stats_file << "num of void pointer: " << num_of_void_pointer_op_ << "\n";
  kernel_idiom_shared_stats_file << "num of unhandled void pointer: " <<  num_of_unhandled_void_pointer_op_ << "\n";
