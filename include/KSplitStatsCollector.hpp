...
namespace pdg
{
  ...
  private:
    ...
    unsigned total_num_of_fields_deep_copy_;
  ...
  public:
    ...
    void IncreaseNumberOfGlobalVar(unsigned size = 0) { num_of_global_var_++; }
    ...
    void SetNumberOfAtomicOperationSharedData(unsigned size) { num_of_atomic_operation_shared_data_ = size; }
    void SetNumberOfCriticalSectionSharedData(unsigned size) { num_of_critical_section_shared_data_ = size; }
    void IncreaseTotalNumberOfFieldForDeepCopy(unsigned num_of_fields) { total_num_of_fields_deep_copy_ += num_of_fields; }
  };
} // namespace pdg
